      ...
      <div className="py-2 flex flex-col mb-10">
        <div className="flex items-center space-x-3 mt-2">
          <Image
            ...
            className="h-8 w-8"
          />
          <h1 className="text-gray-600 text-xl dark:text-gray-300 font-semibold">SentimentSwift</h1>
        </div>
      </div>
      <div className="w-full md:mt-20   max-w-4xl mx-auto">
        <div>
          <h1 className="text-center font-bold text-xl">Admin Only</h1>
        </div>
